...
namespace StackExchange.Exceptional.SourceLink
{
    partial class Native
    {
        ...
        /// <summary>
        /// An application-defined callback function used with the <see cref="SymRegisterCallback64"/> function. It is called by the symbol handler.
        /// </summary>
        ...
        /// <param name="UserContext">User-defined value specified in SymRegisterCallback64, or NULL. Typically, this parameter is used by an application to pass a pointer to a data structure that lets the callback function establish some context.</param>
        /// <returns>
        ...
        public delegate bool SymRegisterCallbackProc64(IntPtr hProcess, SymActionCode ActionCode, IntPtr CallbackData, IntPtr UserContext);
        ...
        /// </remarks>
        [DllImport(DbgHelp, SetLastError = true)]
        public static extern bool SymRegisterCallback64(IntPtr hProcess, [MarshalAs(UnmanagedType.FunctionPtr)]SymRegisterCallbackProc64 CallbackFunction, IntPtr UserContext);
        ...
        /// </remarks>
        [DllImport(DbgHelp, SetLastError = true)]
        public static extern ulong SymLoadModule64(IntPtr hProcess, IntPtr hFile, string ImageName, string ModuleName, IntPtr BaseOfDll, uint SizeOfDll);
